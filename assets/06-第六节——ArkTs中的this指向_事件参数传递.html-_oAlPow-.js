import{_ as n,c as s,o as a,a as p}from"./app-BgCKDSPR.js";const e={},l=p(`<h2 id="一、存在的问题" tabindex="-1"><a class="header-anchor" href="#一、存在的问题"><span>一、存在的问题</span></a></h2><div class="language-typescript line-numbers-mode" data-highlighter="prismjs" data-ext="ts" data-title="ts"><pre class="language-typescript"><code><span class="line"><span class="token decorator"><span class="token at operator">@</span><span class="token function">Entry</span></span></span>
